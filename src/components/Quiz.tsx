...
interface QuizProps {
  onComplete: (data: { score: number; cost: number; eligible: boolean }) => void;
}
...
export default function Quiz({ onComplete }: QuizProps) {
  ...
  const handleSubmit = () => {
    ...
    setResult({ score: Math.round(score), cost, eligible });
    onComplete({ score: Math.round(score), cost, eligible });
  };
